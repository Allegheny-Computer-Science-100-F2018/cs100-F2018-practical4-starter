...
# cs100-F2018-practical4-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Practical 4 in Computer Science 100. Since
...
produces the correct number of output lines.
...
- practicalfour/MadLibs.java:
  ...
  - Contains at least fourteen uses of a `println(` statement
  - Contains exactly one use of a `new Date(` statement
  - Runs correctly without crashing or producing an error
  - Produces exactly fifteen lines of output in the terminal
  - Produces an interesting story containing the word `glitzy` twicce
...
that may differ from the instructor's version of `MadLibs`. As long as your
...
```
git remote add download git@github.com:Allegheny-Computer-Science-100-F2018/cs100-F2018-practical4-starter.git
```
...
Starter](https://github.com/Allegheny-Computer-Science-100-F2018/cs100-F2018-practical4-starter)
repository and create an issue by clicking the "Issues" tab and then clicking
the green "New Issue" button. If you have found a problem with the [GatorGrader
zool](https://github.com/GatorEducator/gatorgrader) and the way that it checks
